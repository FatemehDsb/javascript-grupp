...
const playerListOne = document.querySelector("#playersName1");
const btn3 = document.querySelector("#btn3");

const playerListTwo = document.querySelector("#playersName2");
...
btn3.addEventListener("click", () => {
    ...
    if (amountOfPlayers < 5) {
        ...
        li.innerText = playerListOne.value;
        ...
        moveBtn.addEventListener("click", () => {
            if (amountOfPlayers2 < 5) {
                playerListOne.removeChild(li);
                playerListTwo.appendChild(li);
            }
        });

        playerListOne.appendChild(li);
        li.appendChild(deleteBtnName);
        li.appendChild(moveBtn);
    } else if (amountOfPlayers2 < 5) {
        let li = document.createElement("li");
        li.innerText = playerListOne.value;
